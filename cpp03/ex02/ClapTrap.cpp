...
ClapTrap::ClapTrap( void )
{
	...
	std::cout << this->_name << " has been created through claptrap default constructor" << std::endl;
}
...
ClapTrap::ClapTrap( std::string name )
{
	...
	std::cout << this->_name << " has been created through claptrap name-given constructor" << std::endl;
}

ClapTrap::ClapTrap( const ClapTrap &input)
{
	*this = input;
	std::cout << this->_name << " has been created through claptrap copy constructor" << std::endl;
}

ClapTrap::~ClapTrap( void )
{
	std::cout << this->_name << " has been destroyed through claptrap destructor" << std::endl;
}
